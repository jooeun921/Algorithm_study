...
이거 4949번 문제와 동일함. stack을 활용해서 여는 괄호들을 넣어놓고, 닫힌 괄호가 나올 때마다 stack에서 비교해서(사실 지금 생각해보니까 딱히 비교 안 해도 stack이 비어있지 않으면 pop으로 빼오는 걸로 해도 되긴 했을 듯) pop 사용하기
